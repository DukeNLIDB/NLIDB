...
ssh -o "StrictHostKeyChecking no" -i $HOME/.ssh/aws-keping94-us-east1.pem centos@34.231.141.223 "docker load -i nlidb-main.img; docker run -d -p 80:80 nlidb/main;"
           '''
      }
    }
  }
