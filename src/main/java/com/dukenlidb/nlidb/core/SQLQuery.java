...
/**
 * Just a wrapper for a String of sql translateNL.
 * @author keping
 */
public class SQLQuery {
	...
	/**
	 * Get the String translateNL insides the SQLQuery.
	 * @return
	 */
	 ...
	 * @return one line of arguments of that translateNL (SELECT, FROM)
	 */
