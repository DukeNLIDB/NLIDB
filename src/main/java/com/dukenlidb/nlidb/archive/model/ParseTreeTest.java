...
public class ParseTreeTest {
	 ...
	 * an SQL translateNL, which is what this method is testing for.</p>
	 */
...
/*		
		...
		SQLQuery translateNL = tree.translateToSQL();
		
		// (3) Print out the translateNL and see.
		System.out.println(translateNL);
*/
